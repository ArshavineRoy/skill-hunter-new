...
function Apply({ PostFormObjectToServer, toggleApply }) {
  ...
  return (
    <div>
      <form className="border-none shadow-none pt-0" onSubmit={formSubmit}>
        <div
          class=" mt-0 left-0 top-0 flex justify-center items-center"
          id="modal-id"
        >
          <div class="w-full max-w-lg p-5 relative mx-auto my-auto rounded-xl border bg-white ">
            <div class="">
              ...
              <div class="p-3  mt-2 text-center space-x-4 md:block">
                <button onClick={toggleApply} class="mb-2 md:mb-0 bg-white px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-600 rounded-full hover:shadow-lg hover:bg-gray-100">
                  Cancel
                </button>
                <button
                  type="submit"
